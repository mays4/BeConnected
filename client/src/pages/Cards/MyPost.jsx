...
import { Box, Button, Divider, useMediaQuery, IconButton, InputBase, Typography, useTheme } from "@mui/material";
    ...
    return(
      <CardWrapper>
        <FlexBox gap="1.5rem" sx={{marginBottom:"2rem"}}>
          ...
          <InputBase placeholder="What's on you mind..."
        ...
        {isImage &&(
          <Box  border={`1px solid ${medium}`} borderRadius="5px" marginLeft="2rem" padding="1rem" >
         <Dropzone 
